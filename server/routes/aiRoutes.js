...
const { ingestMaterial, chatRag, summarizeMaterial } = require("../controllers/ragController");
...
router.post("/summarize-material", protect, authorizeRoles("student", "faculty", "admin"), summarizeMaterial);
